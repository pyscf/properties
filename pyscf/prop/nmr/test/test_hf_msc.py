...
def setUpModule():
    global mol, nrhf, rhf, ALPHA_backup
...
class KnownValues(unittest.TestCase):
    def test_nr_common_gauge_ucpscf(self):
        ...
        m.gauge_orig = (1,1,1)
        msc = m.shielding()
        self.assertAlmostEqual(fp(msc), 1636.7413165636394, 5)
    ...
    def test_nr_common_gauge_cpscf(self):
        ...
        m.gauge_orig = (1,1,1)
        msc = m.shielding()
        self.assertAlmostEqual(fp(msc), 1562.3864336632553, 5)
    ...
    def test_nr_giao_ucpscf(self):
        ...
        m.gauge_orig = None
        msc = m.shielding()
        self.assertAlmostEqual(fp(msc), 1488.0948832784416, 5)
    ...
    def test_nr_giao_cpscf(self):
        ...
        m.gauge_orig = None
        msc = m.shielding()
        self.assertAlmostEqual(fp(msc), 1358.9823398356689, 5)
    ...
    def test_rmb_common_gauge_ucpscf(self):
        ...
        m.gauge_orig = (1,1,1)
        msc = m.shielding()
        self.assertAlmostEqual(fp(msc), 1642.1872658333457, 4)
    ...
    def test_rmb_common_gauge_cpscf(self):
        ...
        m.gauge_orig = (1,1,1)
        msc = m.shielding()
        self.assertAlmostEqual(fp(msc), 1569.0413459054728, 4)
    ...
    def test_rmb_giao_ucpscf(self):
        ...
        m.gauge_orig = None
        msc = m.shielding()
        self.assertAlmostEqual(fp(msc), 1493.7229929087348, 4)
    ...
    def test_rmb_giao_cpscf_high_cost(self):
        ...
        m.gauge_orig = None
        msc = m.shielding()
        self.assertAlmostEqual(fp(msc), 1365.4671630053344, 4)
    ...
    def test_rkb_giao_cpscf(self):
        ...
        m.gauge_orig = None
        msc = m.shielding()
        self.assertAlmostEqual(fp(msc), 1923.9098401865144, 4)
    ...
    def test_rkb_common_gauge_cpscf(self):
        ...
        m.gauge_orig = (1,1,1)
        msc = m.shielding()
        self.assertAlmostEqual(fp(msc), 1980.1191128139008, 4)
