...
class KnownValues(unittest.TestCase):
    ...
    def test_nr_giao_cpscf1(self):
        ...
        nmr = mf.NMR()
        msc = nmr.kernel()
        self.assertAlmostEqual(msc[1][0,0], 387.083740, 3)
        self.assertAlmostEqual(msc[1][1,1], 387.083740, 3)
        self.assertAlmostEqual(msc[1][2,2], 482.217408, 3)
        self.assertAlmostEqual(lib.fp(msc), -132.274436056168, 4)


if __name__ == "__main__":
    print("Full Tests of UKS-NMR")
    unittest.main()
